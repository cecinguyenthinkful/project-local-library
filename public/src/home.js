//returns number of books in the array
function getTotalBooksCount(books) {
  const totalBooks = books.map((book) => books); 
  return totalBooks.length
}

//returns number of accounts in the array
...
//returns number of borrowed books in the array
...
//returns top five most common genres
...
//returns top five most popular Authors
